              ...
              <form className="login-form" noValidate onSubmit={handleSubmit}>
                <div className="animated-field">
                  ...
                  <label htmlFor="login-user">
                    {t("login.username").split("").map((char, i) => (
                      <span key={i} style={{ transitionDelay: `${i * 50}ms` }}>{char}</span>
                    ))}
                  </label>
                  {fieldErrors.name && <p className="login-field-error">{fieldErrors.name}</p>}
                </div>
                ...
                <div className="animated-field" style={{ marginBottom: 0 }}>
                  ...
                  <label htmlFor="login-password">
                    {t("login.password").split("").map((char, i) => (
                      <span key={i} style={{ transitionDelay: `${i * 50}ms` }}>{char}</span>
                    ))}
                  </label>
                  <button
                ...
                <div className="login-oauth-group">
                  <button className="login-oauth-btn" type="button" disabled>
